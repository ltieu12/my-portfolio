...
export const ContactPage = () => {
    return (
        <>
            <div className='container mx-auto px-12 md:px-24 mt-20 mb-32 md:flex md:justify-between md:items-center'>
                <div className="md:w-1/2 text-left space-y-5">
                    <h1 className="text-6xl md:text-7xl font-Clash">Let's Talk!</h1>
                    ...
                    <ul className="py-6 md:pb-0 md:pt-16 space-y-1">
                        <li>
