        ...
        <>
            ...
            <div className='container mx-auto px-10 mt-28 md:px-24 lg:mt-20 flex flex-col lg:flex-row lg:justify-between lg:items-center'>
                <div className="pb-16 lg:pb-0 lg:w-1/2 text-left space-y-5">
                    ...
                    <a href="https://drive.google.com/file/d/1ExBwevzX15cxUekzmJnc2vNVU7JVH5NX/view?usp=sharing" target="_blank" rel="noreferrer" className="inline-flex items-center px-4 py-2 font-medium bg-lime-200 border-3 border-black rounded-lg shadow-dark-shadow hover:bg-lime-300">My Resume 
                        <Arrow />
                    </a>
                </div>
