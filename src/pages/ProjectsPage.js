        ...
        <>
            ...
            <div className='container mx-auto px-10 lg:px-24 mb-20 lg:mb-32 lg:flex lg:flex-row justify-between items-center gap-10'>
                <div className="lg:max-w-1/2 lg:text-left space-y-5">
                    <div className="bg-custom-baby-blue px-6 lg:px-10 pt-6 lg:pt-8 pb-10 lg:pb-14 shadow-project-shadow-left rounded-lg border-3 border-black">
            ...
            <div className='container mx-auto px-10 lg:px-24 mb-20 lg:mb-32 flex flex-col-reverse lg:flex-row justify-between items-center gap-10'>
                <div className="lg:w-1/2 lg:text-left text-left space-y-4">
            ...
            <div className='container mx-auto px-10 lg:px-24 mb-20 lg:mb-32 lg:flex lg:flex-row justify-between items-center gap-10'>
                <div className="lg:max-w-1/2 lg:text-left space-y-5">
                    <div className="bg-purple-400 px-6 lg:px-10 pt-6 lg:pt-8 pb-10 lg:pb-14 shadow-project-shadow-left rounded-lg border-3 border-black">
            ...
            <div className='container mx-auto px-10 lg:px-24 mb-20 lg:mb-32 lg:flex lg:flex-row justify-between items-center gap-10'>
                <div className="lg:max-w-1/2 lg:text-left space-y-5">
                    <div className="bg-yellow-200 px-7 lg:px-10 pt-7 lg:pt-8 pb-10 lg:pb-14 shadow-project-shadow-left rounded-lg border-3 border-black">
            ...
            <div className='container mx-auto px-10 lg:px-24 mb-20 lg:mb-32 flex flex-col-reverse lg:flex-row justify-between items-center gap-10'>
                ...
                <div className="lg:max-w-1/2 lg:text-left space-y-5">
                    <div className="bg-lime-300 px-7 lg:px-10 pt-7 lg:pt-8 pb-10 lg:pb-14 shadow-project-shadow-left lg:shadow-project-shadow-right rounded-lg border-3 border-black">
